$(function () {
	addEvent();
	$(".payment-list-page .payment-list-collapse").css("height", $("body").height() - $("header").height() - $(".owner-information").height() - 70);

	function addEvent() {

		$(".payment-list-page").on("click", ".ant-collapse-item", function () {
			...
			if ($(this).hasClass("ant-collapse-item-active")) {
				...
				$(".payment-list-page").find(".ant-collapse-item-active").removeClass("ant-collapse-item-active");
				$(".payment-list-page").find(".ant-collapse-header").attr("aria-expanded", false);
				$(".payment-list-page").find(".ant-collapse-content").removeClass("ant-collapse-item-active");
